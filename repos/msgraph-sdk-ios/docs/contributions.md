# Contributing to the Microsoft Graph SDK for iOS
...
If you are making a change that does not affect the interface components and does not affect other downstream callers, feel free to make a pull request against the __master__ branch.  The master branch will be updated frequently, and the CocoaPods package will be kept closely inline with it.
