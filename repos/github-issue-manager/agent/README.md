...
1. Select your declarative agent from the `Copilot` app.
1. Send a prompt.
...
| File                                 | Contents                                                                       |
| ------------------------------------ | ------------------------------------------------------------------------------ |
| `appPackage/declarativeCopilot.json` | Define the behavior and configurations of the declarative agent.            |
