...
namespace Microsoft.Graph.DotnetCore.Test.Requests.Generated
{
    public class EntityRequestTests
    {
        ...
        public void Expand()
        {
            ...
            var expectedRequestUri = new Uri(string.Format(Constants.Url.GraphBaseUrlFormatString, "v1.0") + "/drives/driveId/items/id?%24expand=value");
        ...
        {            
            var graphServiceClient = new GraphServiceClient(new MockAuthenticationProvider().Object);
            var expectedRequestUri = new Uri(string.Format(Constants.Url.GraphBaseUrlFormatString, "v1.0") + "/drives/driveId/items/id?%24select=value");
